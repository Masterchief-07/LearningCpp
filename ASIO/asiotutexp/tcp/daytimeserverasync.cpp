...
class tcp_connection: public boost::enable_shared_from_this<tcp_connection>
{
	...
	private:
		...
		void handle_write(boost::system::error_code ec, size_t size)
		{
...
{
	public:
		tcp_server(boost::asio::io_context& io_context) : io_context_(io_context), endpoint_(tcp::v4(), 13), acceptor_(io_context, endpoint_)
		{
			std::cout<<"Server: "<<endpoint_<<std::endl;
			start_accept();
		}
